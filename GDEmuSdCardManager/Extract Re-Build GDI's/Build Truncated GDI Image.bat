...
%GUI_Element_1%
Echo  Build truncated GDI image.
Echo:
%GUI_Element_2%
%GUI_Element_3%
timeout /t 2 >NUL
...
%GUI_Element_1%
Echo  Building new truncated image please wait...
..\tools\buildgdi.exe -data "..\%~nx1" -ip "..\%~nx1\bootsector\IP.BIN" -output "" -gdi "%GDI%" -raw -truncate >NUL
Echo  Image creation complete.
timeout /t %Delay% >NUL
exit
